...
<head runat="server">
        <meta charset="utf-8">
    <title>Loan Trusty HomePage</title>w
        ...
        <div class="container">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li><a href="payment.aspx">Pay EMI</a></li>
                    <li class="drop-down">
                        <a href="" class="login-btn" style="margin-top:0px;"><label>User Profile</label></a>
                        <ul>
                            ...
                            <form runat="server">
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <asp:TextBox ID="name" class="form-control" name="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" runat="server"></asp:TextBox>
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <asp:TextBox ID="email" class="form-control" runat="server" name="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email"></asp:TextBox>
                                        <div class="validation"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:TextBox ID="subject" class="form-control" name="subject" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 4 chars of subject" runat="server"></asp:TextBox>
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group">
                                    <asp:TextBox ID="message" class="form-control" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    <div class="validation"></div>
                                </div>
                                <div class="text-center">
                                    <asp:Button ID="Button1" runat="server" style="background-color:#0D86E7;border:hidden;border-radius:5px;padding:5px 5px 5px 5px;font-size:medium;height:40px;color:white;" Text="  Send Message  " OnClick="Button1_Click" />
                                </div>
