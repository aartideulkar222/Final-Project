...
namespace MajorProjectLoanSystem.Models
{
    public class PersonalClass
    {
        ...
        public DateTime App_Doc_Exp { get; set; }
        ...
        public int App_Per_Pin { get; set; }
