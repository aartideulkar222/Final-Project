         ...
         <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                                ...
                                <asp:DropDownList ID="ddl5LoanRequired" runat="server" AutoPostBack="true" OnSelectedIndexChanged="OnSelectedIndexChanged" class="form-control">
                                    <asp:ListItem Value="Choose...">Choose...</asp:ListItem>
                                ...
                                <tbody>
                                   <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <br />
                                            <asp:Label ID="Label37" runat="server" Text="Latest Electricity Bill (For Home Loan)"></asp:Label>
                                        </td>
                                        
                                        <td>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage=" (Invalid Data)" ControlToValidate="ElecticityBillFileUpload" Font-Size="Small" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                            <asp:FileUpload ID="ElecticityBillFileUpload" accept="image/*" class="form-control" runat="server" />
                                            <asp:Label ID="lbl8ElectricityBill" runat="server" Text="(Only Images accepted & Max. Size allowed 256 KB)" Font-Size="Small" ForeColor="Blue"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
